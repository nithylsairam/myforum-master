...
from myforum.accounts.tasks import create_messages
from myforum.emailer.tasks import send_email
from myforum.utils.decorators import spool, timer
...
def update_index(*args):
    ...
    """
    from myforum.forum.models import Post
    from myforum.forum import search
...
def create_user_awards(user_id):
    ...
    from myforum.forum.models import Award, Badge, Post
...
def notify_followers(subs, author, extra_context={}):
    ...
    """
    from myforum.forum.models import Subscription

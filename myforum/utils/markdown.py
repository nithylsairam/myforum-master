"""
Markdown parser to render the myforum style markdown.
"""
import re
...
from myforum.forum import auth
from myforum.forum.models import Post, Subscription
from myforum.accounts.models import Profile, User

# Test input.
TEST_INPUT = '''

https://www.myforums.org/p/1 https://www.myforums.org/p/2
...
class myforumInlineGrammer(InlineGrammar):
    """
...
class myforumInlineLexer(MonkeyPatch):
    grammar_class = myforumInlineGrammer

    def __init__(self, root=None, *args, **kwargs):
        self.root = root

        super(myforumInlineLexer, self).__init__(*args, **kwargs)
...
def parse(text, post=None):
    ...
    inline = myforumInlineLexer(renderer=Renderer(), root=root)
